...
class Register extends React.Component {
	...
	onSubmitSignIn = () => {
		fetch(' https://whispering-forest-34458.herokuapp.com/register', {
			method: 'post',
				...
				<main className="pa4 black-80">
			  		<div className="measure">
			    		<fieldset id="sign_up" className="ba b--transparent ph0 mh0">
			        		...
			        		<input onChange={this.onNameChange} className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-90" type="name" name="name"  id="name"/>
			      			</div>
			     			 <div className="mt3">
